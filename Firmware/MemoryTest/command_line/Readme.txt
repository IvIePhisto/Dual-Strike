...
implementing a special HID device. It also allows dumping flash data.
It is based on Objective Development's bootloadHID program. 
...
~~~~~~~~~~~~~~~~~~~~~~~~~~
-added flash dumping capability
