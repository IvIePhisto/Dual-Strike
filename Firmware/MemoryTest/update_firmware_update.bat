...
ECHO bootloadHID.exe -r "dual_strike_firmware_atmega8_V%1.hex">>firmware_update\update_firmware_atmega8.bat
...
ECHO bootloadHID.exe -r "dual_strike_firmware_atmega8_smd_V%1.hex">>firmware_update\update_firmware_atmega8_smd.bat
