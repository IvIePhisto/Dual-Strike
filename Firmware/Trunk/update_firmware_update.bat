...
ECHO updatefw.exe -r "dual_strike_firmware_V%1.hex">>firmware_update\update_firmware.bat
ECHO Pause>>firmware_update\update_firmware.bat

ECHO @ECHO OFF>firmware_update\update_firmware_smd.bat
ECHO updatefw.exe -r "dual_strike_smd_firmware_V%1.hex">>firmware_update\update_firmware_smd.bat
ECHO Pause>>firmware_update\update_firmware_smd.bat

ECHO @ECHO OFF>firmware_update\update_firmware_wii.bat
ECHO updatefw.exe -r "dual_strike_firmware_V%1_wii.hex">>firmware_update\update_firmware_wii.bat
ECHO Pause>>firmware_update\update_firmware_wii.bat

ECHO @ECHO OFF>firmware_update\update_firmware_smd_wii.bat
ECHO updatefw.exe -r "dual_strike_smd_firmware_V%1_wii.hex">>firmware_update\update_firmware_smd_wii.bat
