...
#define CFG_HOME_EMU (config[1 + 2] & (1<<0))
#define CFG_EMU_4X (config[1 + 2] & (1<<1))
#define CFG_NO_EXTRA_PINS (((config[1 + 2] >> 2) & 0b00000111)  == 0b000)
#define CFG_JOYSTICK_SWITCH_READ (((config[1 + 2] >> 2) & 0b00000111)  == 0b001)
#define CFG_JOYSTICK_SWITCH_EMU (((config[1 + 2] >> 2) & 0b00000111)  == 0b010)
#define CFG_INVERTED_TRIGGERS (((config[1 + 2] >> 2) & 0b00000111)  == 0b011)
...
#define CFG_ENABLE_HOME_EMU(CONFIG) CONFIG[1 + 2] |= (1<<0);
#define CFG_DISABLE_HOME_EMU(CONFIG) CONFIG[1 + 2] &= ~(1<<0);
#define CFG_ENABLE_EMU_4X(CONFIG) CONFIG[1 + 2] |= (1<<1);
#define CFG_DISABLE_EMU_4X(CONFIG) CONFIG[1 + 2] &= ~(1<<1);
#define CFG_SET_NO_EXTRA_PINS(CONFIG) CONFIG[1 + 2] &= ~(0b111 << 2);
#define CFG_SET_JOYSTICK_SWITCH_READ(CONFIG) CONFIG[1 + 2] |= (0b001 << 2); CONFIG[1 + 2] &= ((0b001 << 2)| ~(0b110 << 2));
#define CFG_SET_JOYSTICK_SWITCH_EMU(CONFIG) CONFIG[1 + 2] |= (0b010 << 2); CONFIG[1 + 2] &= ((0b010 << 2)| ~(0b101 << 2));
#define CFG_SET_INVERTED_TRIGGERS(CONFIG) CONFIG[1 + 2] |= (0b011 << 2); CONFIG[1 + 2] &= ((0b011 << 2)| ~(0b100 << 2));
#define CFG_SET_X3_READ(CONFIG) CONFIG[1 + 2] |= (0b100 << 2); CONFIG[1 + 2] &= ((0b100 << 2)| ~(0b011 << 2));
