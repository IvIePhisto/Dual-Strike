 ...
 *         &lt;element name="integerDomain" type="{urn:strike-devices:configuration}IntegerDomain" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 ...
 *       &lt;attribute name="prefix" use="required" type="{urn:strike-devices:configuration}SettingID" />
...
public class OriginalConfiguration {
    ...
    @XmlElement(required = true)
    protected List<IntegerDomain> integerDomain;
    ...
    /**
     * Gets the value of the integerDomain property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the integerDomain property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getIntegerDomain().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<IntegerDomain> getIntegerDomain() {
        if (integerDomain == null) {
            integerDomain = new ArrayList<IntegerDomain>();
        }
